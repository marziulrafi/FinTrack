      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-md overflow-hidden grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="mt-auto">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-3 bg-white/90 text-slate-800 px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition"
                type="button"
        ...
        <div className="p-8">
          ...
          <form onSubmit={mode === "login" ? handleLogin : handleRegister} className="space-y-4">
            {mode === "register" && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-sky-200"
                />
              </div>
            )}
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full inline-flex items-center justify-center gap-2 bg-sky-600 text-white px-4 py-2 rounded-lg hover:bg-sky-700 disabled:opacity-60"
              >
          ...
          <div className="mt-6 text-center text-sm text-slate-400">
            By continuing you agree to FinTrack's Terms and Privacy.
          </div>
        </div>
      </div>
    </div>
